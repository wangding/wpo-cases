...
- [快速加载](docs/fast-load-time.md)
  ...
  - —— 优化图片 ——
  - [Choose the right image format](docs/fast-load-time/choose-the-right-image-format.md)
  - [Choose the correct level of compression](docs/fast-load-time/compress-images.md)
  - [使用 Imagemin 压缩图像](docs/fast-load-time/use-imagemin-to-compress-images.md)
  - [Replace animated GIFs with video for faster page loads](docs/fast-load-time/replace-gifs-with-videos.md)
  - [提供响应式图像](docs/fast-load-time/serve-responsive-images.md)
  - [Serve images with correct dimensions](docs/fast-load-time/serve-images-with-correct-dimensions.md)
  ...
  - [Browser-level image lazy-loading for the web](docs/fast-load-time/browser-level-image-lazy-loading.md)
